...
void stack_confirm() {
    if (*(volatile u64 *)(&_stack_bottom_test) != stack_end_magic_num) {
        PANIC("DATA_HAS_BEEN_WRITTEN_BELOW_STACK", *(volatile u64 *)((u64)&_stack_bottom_test), (s64)(&_stack_bottom_test), 0);
    }
    if (*(volatile u64 *)(&_stack_top_test) != stack_top_magic_num) {
        PANIC("DATA_HAS_BEEN_WRITTEN_ABOVE_STACK", *(volatile u64 *)((u64)&_stack_top_test), (s64)(&_stack_top_test), 0);
    }
}
